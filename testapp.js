...
var commentArrow = require('fs').readFileSync('commentArrow.js');
var commandFilter = require('fs').readFileSync('commandFilter.js');
...
var http = require('http').createServer(
    function (req, res) {
        ...
        if ('/' == url) {
            ...
            res.end(commentArrow);
        } else if ("/commandFilter.js" == url) {
            res.writeHead(200, {
                'Content-Type': 'text/plain'
            });
            res.end(commandFilter);
        }
